            ...
            <div className='col-12'>
              <div className='auth-content'>
                ...
                >
                      ...
                      <div className='auth-contentForm'>
                        ...
                        <div className='inputGroup'>
                          <label htmlFor='phoneNumber' className='form-label'>
                            {t('forms.phoneNumber')} <span className='text-muted'>(optional)</span>
                          </label>
                          <input
                            type='tel'
                            className='form-control'
                        ...
                        <div className='mt-4'>
                          <Link to={'/login'} className='customBtn btn-bgGreen w-100 text-center d-block'>
                  ...
                  <Tab eventKey='professional' title={t('buttons.professionalAccount')}>
                    <form onSubmit={handleSubmit}>
                      <div className='auth-contentForm'>
                        <div className='inputGroup'>
                        ...
                        <div className='inputGroup'>
                          <label htmlFor='userPasswordPro' className='form-label'>
                            {t('forms.password')}
                          </label>
                          <input
                            type='password'
                        ...
                        <div className='inputGroup'>
                          <label htmlFor='userPasswordConfirmPro' className='form-label'>
                            {t('forms.confirmPassword')}
                          </label>
                          <input
                            type='password'
                        ...
                        <div className='inputGroup'>
                          <label htmlFor='phoneNumberPro' className='form-label'>
                            {t('forms.phoneNumber')} <span className='text-muted'>(optional)</span>
                          </label>
                          <input
                            type='tel'
